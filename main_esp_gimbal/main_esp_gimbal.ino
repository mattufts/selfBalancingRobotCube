...
double kp = 1.6, ki = 0.005, kd = 0;    // tuning parameters
...
double lidar_height_mm = 38 + 21.25; // 38 from bottom of base to to center of bearing; 21.25 from center of bearing to lidar mount
double lidar = 0;
...
double get_angle( float (& angles) [3])
{
  ...
  /*Serial.print(" imu_angle: "); */Serial.print(imu_angle);
  Serial.print(","); Serial.print(lidar_angle);
...
{
  lidar = lox.readRange();
  // Serial.print(" raw_lidar:"); Serial.print(lidar);
  return lidar;
  // return 0;
}
